...
export default function AuthorizedSetupGuide() {
  return (
    <section className={styles.setup_guide}>
      <div className={styles.setup_guide__header}>
      ...
      <div className={styles.setup_guide__body}>
        <div className={styles.setup_guide__item}>
          <div>
            <div
